...
export const costCard_NhaTam: TableData = {
  ...
  rows: [
    ...
    ["Chi phí bán hàng", "", "", "43.364.000"],
    ["Tổng giá thành", "400.000.000", "", "320.600.000"],
    ["Số lượng sản xuất (cái)", "8.000", "", "8.000"],
    ["Giá thành đơn vị (đ)", "50.000", "", "40.075"]
  ]
};
...
export const costCard_NhaBep: TableData = {
  ...
  rows: [
    ...
    ["Chi phí bán hàng", "", "", "214.756.000"],
    ["Tổng giá thành", "600.000.000", "", "361.190.000"],
    ["Số lượng sản xuất (cái)", "5.000", "", "5.000"],
    ["Giá thành đơn vị (đ)", "120.000", "", "72.238"]
  ]
};
